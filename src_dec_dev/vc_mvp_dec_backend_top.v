// T07-B Decoder backend integration.  The AVC Candidate calculation remains
// an explicit external seam; Neighbor, reconstruction, and MC are real blocks.
module vc_mvp_dec_backend_top #(
    ...
    // External Candidate seam: the real Candidate instance will replace this
    // boundary in a later task without bypassing the controller handshakes.
    ...
    // Decoder Neighbor SRAM/Col/RefList interfaces are passed through so the
    // backend retains the real legacy Neighbor hierarchy.
    ...
    // Ownership-routed acknowledgement from the MC-side Decoder producer leg.
    ...
    // Transaction/backend observability for integration and system wiring.
    ...
    vc_mvp_dec_recon U_RECON (
        ...
        .dec_is_pic_top16   (dec_is_pic_top16),
        .dec_is_pic_left16  (dec_is_pic_left16),
        .dec_skip_a1_avail  (dec_a_avail[1]),
        .dec_skip_b1_avail  (dec_b_avail[1]),
        .dec_skip_a1_mv     (amvp_neib_a[1][31:0]),
        .dec_skip_b1_mv     (amvp_neib_b[1][31:0]),
