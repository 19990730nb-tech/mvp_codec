// -----------------------------------------------------------------------------
// Common block-size and cache-layout macros inherited from the encoder RTL.
// ve_reg_struct.v is a project-wide dependency supplied by the parent build;
// the MVP modules in this directory do not directly consume its declarations.
// -----------------------------------------------------------------------------
